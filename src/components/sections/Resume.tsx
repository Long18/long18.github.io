...
export default function Resume({ className = '' }: ResumeProps) {
  ...
  const stats = [
    { icon: Trophy, label: "Years Experience", value: "5+", color: "orange", delay: 0.1 },
    { icon: Rocket, label: "Projects Completed", value: "30+", color: "purple", delay: 0.2 },
    { icon: Star, label: "Technologies", value: "20+", color: "cyan", delay: 0.3 },
    { icon: Users, label: "Team Projects", value: "15+", color: "emerald", delay: 0.4 },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-orange-300 font-semibold">Professional Journey</span>
          </motion.div>
          ...
          >
            A journey through my professional growth, showcasing the experiences and education that shaped my expertise in game development.
          </motion.p>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-3xl p-6 border border-gray-700/50 hover:border-orange-500/50 transition-all duration-500 text-center overflow-hidden">
                ...
                <p className="text-gray-300 text-sm font-medium relative z-10">{stat.label}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'experience' && (
            ...
            >
              ...
              >
                <motion.div
                  animate={{ rotate: hoveredSection === 'experience' ? 360 : 0 }}
                  transition={{ duration: 0.6 }}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400">Academic foundation and learning journey</p>
                </div>
              </motion.div>
          ...
          <div className="bg-gradient-to-r from-orange-500/10 via-purple-500/10 to-cyan-500/10 backdrop-blur-xl rounded-3xl p-8 border border-orange-500/20 hover:border-orange-500/40 transition-all duration-500 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-5">
              <motion.div
                ...
                style={{
                  backgroundImage: 'radial-gradient(circle at 50% 50%, #f97316 2px, transparent 2px)',
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Technologies I'm passionate about</p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  { 
                    ...
                    skills: ["SOLID Principles", "Design Patterns", "Agile", "CI/CD"],
                    icon: Layers,
                    color: "cyan"
                  }
                ].map((category, index) => (
