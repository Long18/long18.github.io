  ...
  return (
    <section className="space-y-6 mb-6">
      ...
      <div className="bg-white rounded-2xl shadow p-4 sm:p-6" aria-label="Monthly income expense balance chart">
        <h2 className="text-base sm:text-lg font-semibold mb-4">Monthly income vs expense vs balance - Thu, Chi, Cân đối theo tháng</h2>
      ...
      <div className="bg-white rounded-2xl shadow p-4 sm:p-6" aria-label="Category share donut">
        <h2 className="text-base sm:text-lg font-semibold mb-4">Category share this month - Tỉ trọng chi theo nhóm (cha)</h2>
