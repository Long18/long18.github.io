              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold text-white-1 mb-3">
                        Description
                      </h3>
                      <p className="text-white-2 leading-relaxed text-sm sm:text-base">
                        {project.description}
                      </p>
                    </div>
                          ...
                          <ul className="space-y-2">
                            {project.achievements.map(
                              (achievement: string, index: number) => (
                                <li
                                  key={index}
                                  className="text-white-2 flex items-start gap-3 text-sm sm:text-base"
                                >
                                  <span className="text-orange-400 mt-1 text-xs shrink-0">
                                    ●
                                  </span>
                                  {achievement}
                                </li>
